...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("growwithtalha@outlook.com")
      ...
      <div className={`${id === 6 && "flex  justify-center"} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation>
            {/* <div className="absolute flex items-center text-white justify-center font-bold z-50 " /> */}
          </BackgroundGradientAnimation>
        )}
        <div
          className={cn(
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 lg:gap-8">
                ...
                {["Docker", "Flask", "TailwindCSS"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:py-4 px-3 lg:px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132e]"
                  >
